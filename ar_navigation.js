   ...
   $.ajax({
    ...
    success: function (response) {
        let images = {
            ...
            "turn_left": "assests/ar_left.png",
            "slight_right": "assests/ar_slight_right.png",
            "slight_left": "assests/ar_slight_left.png",
            "straight": "assests/ar_straight.png",
        }
        let steps = response.routes[0].legs[0].steps
        for (let i = 0; i < steps.lenght; i++) {
            let image;
            let distance = steps[i].distance
            let instruction = steps[i].manevuer.instruction
            ...
            if (i > 0) {
                $("#scene_container").append(
                    `<a-entity
                        gps-entity-place="latitude: ${steps[i].manevuer.location[1]};
                        longitude: ${steps[i].manevuer.location[0]};">
                            <a-image
                                name="${instruction}"
